...
from .views import user_info, set_environment, delete_environment, get_apps, create_github_account, create_slack_account, get_images, get_profile, set_single_app, RoleView
from .chatbot import chat_bot
# from .views import create_app, create_role, get_role_apps
...
urlpatterns = [
    ...
    path('role/<str:role_name>/',RoleView.as_view(), name='roleview'),
    path('role/<str:role_name>/<str:app_name>/',RoleView.as_view(), name='roleview'),
]